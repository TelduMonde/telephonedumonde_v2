...
export default function CardVariant({
  ...
  return (
    <div>
      <div className="relative group w-full lg:min-w-[300px] lg:min-h-[350px] pt-4 hover:shadow-2xl transition-all ease-in-out duration-300 rounded-md">
        {/* DRAPEAU */}
        ...
        <div className="bg-gradient-to-b from-noir-900 to-noir-800 h-[150px] lg:h-[170px] -mt-10 rounded-md transition-all ease-in-out duration-300 z-10">
          <div className="px-3 lg:px-0 lg:wrapper flex flex-col gap-2 justify-center">
            <p className="pt-10 lg:pt-8 text-xs text-noir-100 text-center">
      ...
      <div className="mt-2 flex flex-col lg:flex-row gap-1">
        ...
        <button
          ...
          className="text-white font-fontb text-xs hover:text-white/70"
        >
          Retirer des favoris
        </button>
      </div>
