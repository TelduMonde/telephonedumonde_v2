...
const DeleteShippingMethodBtn: React.FC<DeleteShippingMethodProps> = ({
  shippingMethodId,
}) => {
  ...
  return (
    <>
      ...
      <ModalAdmin isOpen={isModalOpen} onClose={handleCloseModal}>
        ...
        <p>Êtes-vous sûr de vouloir supprimer cete méthode de livraison ?</p>
...
export default DeleteShippingMethodBtn;
