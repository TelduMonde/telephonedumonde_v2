...
export const metadata: Metadata = {
  title: "Le Concept | Téléphone du Monde | Smartphones à Prix Réduits",
  description:
    "Découvrez le concept de Téléphone du Monde, la plateforme qui vous permet d'acheter des smartphones internationaux de qualité à des prix compétitifs. Qualité garantie, livraison rapide, et économies garanties.",
  keywords: [
    "concept smartphones",
        ...
        <div className="flex flex-col justify-center gap-4 lg:flex-row lg:gap-10">
          ...
          <div className="lg:w-2/3 flex flex-col gap-6">
            <p className=" text-white font-font1">
              ...
              Que vous soyez en France ou ailleurs, nous vous permettons
            ...
            <ul className="list-disc list-inside text-white font-font1">
              <li>
                <span className="font-bold">Des prix compétitifs</span> :
                Achetez des smartphones équivalents aux modèles disponibles en
                France, mais à un tarif bien plus abordable.
              </li>
              <li>
                <span className="font-bold">Une qualité garantie</span> : Tous
                nos téléphones sont 100% neufs et conformes aux standards
                internationaux.
              </li>
              <li>
                <span className="font-bold">Livraison rapide</span> : Une fois
                votre commande validée, recevez votre smartphone en seulement 7
                à 10 jours.
              </li>
              <li>
                <span className="font-bold">Économies garanties</span> :
                Réalisez des économies importantes tout en bénéficiant de la
                même technologie de pointe.
              </li>
            </ul>
            <p className=" text-white font-font1">
              Ne laissez pas passer cette opportunité d’acheter un smartphone de
              qualité à moindre coût. Profitez d’une expérience simple, rapide
              et économique avec Téléphones du Monde.{" "}
